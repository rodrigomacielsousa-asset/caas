        ...
        <div className="mb-12">
          ...
          <div className="relative mb-8">
            ...
            <input 
              ...
              className="w-full bg-slate-50 dark:bg-slate-800 border-none rounded-xl pl-10 pr-4 py-2.5 text-xs font-medium focus:ring-2 focus:ring-blue-500" 
            />
          </div>
            ...
            {SECTIONS.map((section) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <section.icon className={cn("w-4 h-4", activeSection === section.id ? "text-blue-600" : "text-slate-400")} />
        ...
        >
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex gap-4 p-8 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[32px]">
                   <div className="w-12 h-12 bg-blue-50 text-blue-600 rounded-2xl flex-shrink-0 flex items-center justify-center"><Server className="w-6 h-6" /></div>
                   <div>
                ...
                <div className="flex gap-4 p-8 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[32px]">
                   <div className="w-12 h-12 bg-blue-50 text-blue-600 rounded-2xl flex-shrink-0 flex items-center justify-center"><Globe className="w-6 h-6" /></div>
                   <div>
          ...
          {activeSection === 'security' && (
            <div className="space-y-8">
               ...
               <div className="bg-blue-600 p-12 rounded-[48px] text-white overflow-hidden relative">
                 ...
                 <div className="relative z-10">
                    ...
                    <p className="text-blue-100 mb-8 max-w-xl text-lg font-medium">Nosso ecossistema utiliza criptografia AES-256 para repouso de dados e TLS 1.3 para trânsito. Nenhuma solução é publicada sem auditoria de Zero-Trust.</p>
                    <button className="bg-white text-blue-600 px-8 py-4 rounded-2xl font-bold hover:scale-105 transition-all flex items-center gap-2">
