...
export default function ReceiptorBr() {
  ...
  const handleUpload = async (e?: React.FormEvent) => {
    ...
    // Credit Check
    const cost = file.name.toUpperCase().endsWith('.XML') ? 1 : 2;
    if (profile.credits < cost) {
      setError(`Créditos insuficientes (${profile.credits}). Este documento requer ${cost} créditos.`);
      return;
    }
    ...
    try {
      ...
      // Consume Credits - Using setDoc with merge to be safer
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col">
       ...
       <div className="bg-indigo-600 px-6 py-2 flex justify-between items-center text-white border-b border-indigo-500 shadow-sm z-30">
          <div className="flex items-center gap-3">
             ...
             <p className="text-[10px] font-bold opacity-80 uppercase tracking-widest">Vencimento: 25/05/2026</p>
          </div>
          <div className="flex items-center gap-4">
             <div className="flex items-center gap-4 text-[10px] font-black uppercase tracking-widest">
                <span className="opacity-70">Seus Créditos:</span>
                <span className="bg-white text-indigo-600 px-3 py-1 rounded-full shadow-lg">{profile?.credits || 0}</span>
             </div>
       ...
       <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 p-8 pt-10 sticky top-0 z-20 shadow-sm">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="flex items-center gap-4">
               <div className="w-14 h-14 bg-indigo-600 rounded-3xl flex items-center justify-center text-white shadow-xl shadow-indigo-100 dark:shadow-none"><Receipt className="w-7 h-7" /></div>
               <div>
                  <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tighter italic leading-none">Receiptor.BR</h1>
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1 italic">Engine de Extração Fiscal & Contábil</p>
               </div>
            </div>
            ...
            <div className="flex items-center gap-6">
               ...
               <button className="p-4 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-800 rounded-2xl text-slate-400 hover:text-indigo-600 transition-all shadow-sm">
       ...
       <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-10 flex-1 flex flex-col">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
             ...
             <div className="space-y-10">
                <div className="p-10 md:p-16 bg-white dark:bg-slate-900 rounded-[56px] border-4 border-dashed border-slate-100 dark:border-slate-800 text-center space-y-8 group hover:border-indigo-400 transition-all cursor-pointer relative overflow-hidden shadow-sm">
                   {/* Decoration */}
                   <div className="absolute top-0 right-0 p-8 text-indigo-600/5 group-hover:scale-110 transition-transform pointer-events-none"><Database className="w-48 h-48" /></div>
                   
                   <div className="relative z-10 space-y-8">
                      <div className="w-24 h-24 bg-indigo-50 dark:bg-indigo-900/30 rounded-[32px] flex items-center justify-center mx-auto text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white transition-all duration-500 shadow-inner">
                         <Upload className="w-10 h-10" />
                      </div>
                      <div className="space-y-3">
                         <h2 className="text-3xl font-black text-slate-900 dark:text-white leading-tight uppercase italic underline decoration-indigo-600/30 underline-offset-8">Receiptor<br /> Live Engine.</h2>
                      ...
                      <div className="space-y-4">
                        <select 
                          ...
                          className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl px-6 py-4 text-xs font-black uppercase tracking-widest outline-none focus:ring-2 focus:ring-indigo-600 transition-all appearance-none text-center"
                        >
                        ...
                        {file ? (
                          <div className="p-4 bg-indigo-600 text-white rounded-2xl flex items-center justify-between mx-auto max-w-xs shadow-xl animate-bounce">
                             <div className="flex items-center gap-3">
                          ...
                          <div className="relative">
                             ...
                             <div className="py-4 border border-indigo-100 bg-indigo-50/50 rounded-2xl text-[10px] font-black text-indigo-600 uppercase tracking-widest group-hover:bg-indigo-600 group-hover:text-white transition-all">
                      ...
                      <button 
                        ...
                        className={cn(
                          ...
                          !file || isProcessing 
                            ...
                            : "bg-indigo-600 text-white hover:bg-slate-900 hover:scale-[1.02]"
                        )}
                      >
                        ...
                        <div className="p-4 bg-rose-50 text-rose-600 rounded-2xl border border-rose-100 flex flex-col gap-4 text-xs font-bold text-left animate-shake">
                           ...
                           {!user && (
                             <button 
                               ...
                               className="bg-indigo-600 text-white px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-slate-900 transition-colors self-start"
                             >
                               Entrar com Google
                             </button>
                           )}
                ...
                <div className="bg-slate-900 rounded-[48px] p-8 text-white relative overflow-hidden">
                   ...
                   <div className="relative z-10 space-y-6">
                      ...
                      <div className="flex gap-3">
                         ...
                         <div className="px-4 py-2 bg-white/5 rounded-xl border border-white/10 text-[9px] font-black uppercase tracking-widest flex items-center gap-2">
                            <span className="w-1.5 h-1.5 rounded-full bg-indigo-400 animate-pulse" /> Pré-Contábil Ready
                         </div>
                      </div>
                   </div>
                </div>
                      ...
                      {!result ? (
                        ...
                        >
                           <div className="w-24 h-24 bg-slate-50 dark:bg-slate-800 rounded-[32px] flex items-center justify-center text-slate-200 shadow-inner">
                              {isProcessing ? <Loader2 className="w-12 h-12 animate-spin text-indigo-400" /> : <Search className="w-12 h-12" />}
                           </div>
                        ...
                        >
                           <div className="p-10 space-y-10 flex-1">
                              ...
                              <div className="flex justify-between items-start border-b border-slate-100 dark:border-slate-800 pb-8">
                                 <div className="space-y-4">
                                    <div className="flex items-center gap-3">
                                       <span className={cn(
                                         ...
                                         result.tipoDoc === 'NFE_XML' ? "bg-emerald-50 text-emerald-600" : "bg-indigo-50 text-indigo-600"
                                       )}>
                                          {result.tipoDoc}
                                       </span>
                                 ...
                                 <div className="text-right space-y-2">
                                    ...
                                    <p className="text-4xl font-black text-indigo-600 italic leading-none">R$ {result.totais.valorTotal.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</p>
                                 </div>
                              </div>
                              ...
                              <div className="py-2">
                                 {activeTab === 'resumo' && (
                                   <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                      ...
                                      <div className="md:col-span-2 p-8 bg-indigo-50/50 dark:bg-indigo-900/10 rounded-[40px] border border-indigo-100 dark:border-indigo-800 flex items-center justify-between">
                                         <div className="space-y-1">
                                            <p className="text-[10px] font-black text-indigo-600 uppercase tracking-widest italic">Chave NF-e / ID</p>
                                            <p className="text-xs font-bold text-slate-500 font-mono break-all line-clamp-1">{result.chave || 'SEM CHAVE ACESSO'}</p>
                                         </div>
                                         <button className="p-3 bg-white dark:bg-slate-800 rounded-xl text-indigo-600 hover:bg-indigo-600 hover:text-white transition-all shadow-sm"><Copy className="w-4 h-4" /></button>
                                      </div>
                                   </div>
                                 )}
                                 ...
                                 {activeTab === 'impostos' && (
                                   <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                      {[
                                        { label: 'ICMS Total', val: result.totais.impostos.icms, color: 'text-indigo-600' },
                                 ...
                                 {activeTab === 'contabil' && (
                                   <div className="space-y-8">
                                      <div className="flex items-center justify-between px-2">
                                         <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest italic flex items-center gap-2"><Sparkles className="w-4 h-4 text-indigo-600" /> Sugestão da IA Receiptor</h4>
                                         <div className={cn(
                                      ...
                                      <div className="bg-slate-900 rounded-[48px] p-10 text-white space-y-8 relative overflow-hidden ring-4 ring-indigo-600/10 shadow-2xl">
                                         ...
                                         <div className="grid grid-cols-1 md:grid-cols-2 gap-10 relative z-10">
                                            ...
                                            <div className="space-y-6">
                                               <div className="space-y-2">
                                                  <div className="text-[10px] font-black text-indigo-400 uppercase tracking-widest">Histórico Padrão</div>
                                 ...
                                 {activeTab === 'export' && (
                                   <div className="space-y-8 py-10">
                                      ...
                                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                         <button onClick={exportToExcel} className="p-6 bg-white dark:bg-slate-800 rounded-[40px] border border-slate-100 dark:border-slate-800 flex items-center gap-4 hover:border-indigo-600 hover:shadow-xl transition-all group">
                                            ...
                                            <ChevronRight className="w-5 h-5 ml-auto text-slate-200 group-hover:text-indigo-600" />
                                         </button>
                                         <button className="p-6 bg-white dark:bg-slate-800 rounded-[40px] border border-slate-100 dark:border-slate-800 flex items-center gap-4 hover:border-indigo-600 hover:shadow-xl transition-all group">
                                            <div className="w-12 h-12 bg-slate-50 rounded-2xl flex items-center justify-center text-slate-400 group-hover:bg-indigo-600 group-hover:text-white transition-all"><FileText className="w-6 h-6" /></div>
                                            <div className="text-left">
                           ...
                           <div className="p-4 bg-slate-50 dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800 flex gap-4">
                              <button 
                                onClick={handleSave}
                                disabled={isSaving}
                                className="flex-1 py-5 bg-indigo-600 text-white rounded-[32px] font-black text-lg tracking-tighter italic flex items-center justify-center gap-3 hover:bg-slate-900 transition-all shadow-xl shadow-indigo-100 dark:shadow-none"
                              >
          ...
          <div className="mt-20 pt-10 border-t border-slate-100 dark:border-slate-800 flex flex-col md:flex-row justify-between items-center gap-8 text-slate-400 font-medium">
             ...
             <div className="flex gap-8 text-[10px] font-black uppercase tracking-widest">
                ...
                <a href="#" className="hover:text-indigo-600 transition-colors">Política de Retenção</a>
                <a href="#" className="hover:text-indigo-600 transition-colors">Suporte Técnico</a>
             </div>
          </div>
       </div>
          ...
          {profile && profile.credits <= 0 && profile.plan === 'free' && (
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
               ...
               >
                  ...
                  <div className="w-24 h-24 bg-indigo-50 rounded-[40px] flex items-center justify-center mx-auto text-indigo-600 shadow-inner">
                     <AlertTriangle className="w-12 h-12" />
                  </div>
                  <div className="space-y-4">
                     <h3 className="text-4xl font-black text-slate-900 tracking-tighter uppercase italic leading-none">Créditos<br />Esgotados.</h3>
                     <p className="text-sm text-slate-500 leading-relaxed max-w-xs mx-auto">Você atingiu seu limite de 3 documentos mensais no plano FREE. Desbloqueie o Receiptor PRÓ para continuar.</p>
                  </div>
                  <div className="space-y-4">
                     <button className="w-full py-6 bg-indigo-600 text-white rounded-[32px] font-black text-xl tracking-tighter italic uppercase shadow-2xl shadow-indigo-200">Seja Receiptor PRO</button>
