        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
           <div className="max-w-4xl mx-auto space-y-8">
              ...
              <h1 className="text-5xl md:text-8xl font-black text-white tracking-tighter leading-[0.9]">
                Contabilidade como <br /> <span className="text-blue-200">Serviço Modular.</span>
              </h1>
              <p className="text-xl md:text-2xl text-blue-100 font-medium leading-relaxed italic font-serif max-w-3xl mx-auto">
              ...
              <div className="flex flex-wrap justify-center gap-4 pt-8">
                 <Link to="/solucoes" className="px-8 py-4 bg-white text-blue-600 rounded-2xl font-bold text-lg shadow-xl hover:scale-105 transition-all">
                   Ver Catálogo de Soluções
                 </Link>
                 <Link to="/publicar" className="px-8 py-4 bg-blue-500 text-white rounded-2xl font-bold text-lg border border-blue-400 hover:bg-blue-400 transition-all">
         ...
         <section className="py-32 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div className="space-y-12">
               <div className="space-y-4">
                  <span className="text-xs font-bold text-blue-600 uppercase tracking-widest">Nosso Manifesto</span>
                  <h2 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white tracking-tighter leading-none">
                    A morte do software monolítico e o nascimento do <span className="text-blue-600 italic">Accounting as a Service.</span>
                  </h2>
               </div>
            ...
            <div className="relative">
               <div className="absolute -inset-4 bg-blue-600/10 blur-[80px] rounded-full" />
               <div className="bg-slate-900 rounded-[64px] p-12 text-white space-y-12 relative z-10 border border-white/5">
                  <div className="space-y-4">
                    ...
                    <p className="text-blue-200/60 font-medium">A fragmentação produtiva é o novo padrão ouro de eficiência.</p>
                  </div>
                  <div className="grid grid-cols-2 gap-8">
                     <div className="space-y-2">
                        <span className="text-4xl font-black text-white">98%</span>
                        <p className="text-[10px] uppercase font-bold text-blue-400 tracking-widest">Precisão de Cálculos</p>
                     </div>
                     <div className="space-y-2">
                        <span className="text-4xl font-black text-white">10x</span>
                        <p className="text-[10px] uppercase font-bold text-blue-400 tracking-widest">Mais Ágil que ERPs</p>
                     </div>
                     <div className="space-y-2">
                        <span className="text-4xl font-black text-white">40+</span>
                        <p className="text-[10px] uppercase font-bold text-blue-400 tracking-widest">Microsoluções</p>
                     </div>
                     <div className="space-y-2">
                        <span className="text-4xl font-black text-white">ZERO</span>
                        <p className="text-[10px] uppercase font-bold text-blue-400 tracking-widest">Taxa de Adesão</p>
                     </div>
                  </div>
